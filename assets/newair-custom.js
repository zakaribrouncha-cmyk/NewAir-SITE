...
(function(){
  ...
  function keepOnlyTikTok(){
    ...
    var holders=[];
    document.querySelectorAll('a[href*="discord.gg"],a[href*="tiktok.com"]').forEach(function(a){if(a.parentElement)holders.push(a.parentElement)});
    holders.forEach(function(holder){
      ...
      link.setAttribute('data-newair-tiktok','1');
      link.className='hover:text-white transition-colors';
      link.innerHTML=tiktokIcon;
  ...
  function addStyle(){
    ...
    s.id='newair-light-style';
    s.textContent='.newair-connected-account{max-width:210px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;border-color:rgba(95,150,214,.55)!important;background:rgba(11,42,91,.18)!important;color:#d9e9ff!important;box-shadow:0 0 20px rgba(95,150,214,.24)!important}';
